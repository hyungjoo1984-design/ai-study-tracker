...
export default function App() {
  ...
  const [form,           setForm]          = useState({ field:"", examDate:"", dailyHours:"1", background:"", notes:"" });
  ...
  const [materialForm,   setMaterialForm]  = useState({ title:"", type:"book", url:"", planIdx:-1, tags:"", notes:"" });
  ...
  const saveMaterial = async () => {
    ...
    setMaterialForm({ title:"", type:"book", url:"", planIdx:-1, tags:"", notes:"" });
  };
          ...
          {activeTab === "record" && (
            <div>
              ...
              {recordView === "materials" && (
                <div>
                  <button onClick={() => { setMaterialForm({ title:"", type:"book", url:"", planIdx: selectedPlanFilter >= 0 ? selectedPlanFilter : -1, tags:"", notes:"" }); setMaterialModal({}); }}
                        ...
                        <div key={m.id} style={{ background:"#16162A", borderRadius:14, padding:"16px", marginBottom:10, border:"1px solid #2A2A45" }}>
                          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
                            ...
                            <div style={{ display:"flex", gap:6, flexShrink:0, marginLeft:10 }}>
                              <button onClick={() => { setMaterialForm({ title:m.title, type:m.type, url:m.url, planIdx:m.planIdx, tags:m.tags?.join(", ")||"", notes:m.notes }); setMaterialModal(m); }}
